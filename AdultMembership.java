...
public class AdultMembership extends Membership {
    ...
    public AdultMembership(String adultType, String adultName, String adultDOB, String adultAddress, String adultEmail, String pOccupation, String adultClassChosen) {
        super(adultType, adultName, adultDOB, adultAddress, adultEmail, adultClassChosen);
