...
//        StudentMembership student3 = new StudentMembership(type, name, dob, address, email, university, sdfo.parse(gradDate));
//
...
//        while (itr.hasNext()) {
//            StudentMembership studentMembership = (StudentMembership) itr.next();
//            System.out.println("Name: " + studentMembership.name + "\tMemberID: " + studentMembership.memberID);
//        }
//
...
//
//                    if (usernameAttempt.equals(studentList.get(index).getID()) && (passwordAttempt.equals(studentList.get(index).getPassword()))) {
...
//                    }//else
//
//            } while (((!usernameAttempt.equals(studentList.get(num).getID()) || (!passwordAttempt.equals(studentList.get(num).getPassword())))));
//        }//login
